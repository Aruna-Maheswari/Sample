...
public class UserService {
	...
	public List<Map<String, Object>> getEmail(String mail) {

		String query = "SELECT *FROM userdetails WHERE mail=:usermail";

		SqlParameterSource sqlparametersource = new MapSqlParameterSource().addValue("usermail", mail);
